...
$rpc = apply_filters('juanjimeneztj_related_products_columns', $rpc);
...
if(!empty($juanjimeneztj['related_products_text'])) {
	$relatedtext = $juanjimeneztj['related_products_text'];
} else {
	$relatedtext = __( 'Related Products', 'juanjimeneztj');
}
