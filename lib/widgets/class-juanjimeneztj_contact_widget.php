...
class juanjimeneztj_contact_widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'widget_juanjimeneztj_contact', 'description' => __('Use this widget to add a Vcard to your site', 'juanjimeneztj'));
        parent::__construct('widget_juanjimeneztj_contact', __('juanjimeneztj: Contact/Vcard', 'juanjimeneztj'), $widget_ops);
    }
