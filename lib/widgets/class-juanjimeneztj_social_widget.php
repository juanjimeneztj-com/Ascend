...
class juanjimeneztj_social_widget extends WP_Widget {
    ...
    public function __construct() {
    	$widget_ops = array('classname' => 'widget_juanjimeneztj_social', 'description' => __('Simple way to add Social Icons', 'juanjimeneztj'));
    	parent::__construct('widget_juanjimeneztj_social', __('juanjimeneztj: Social Links', 'juanjimeneztj'), $widget_ops);
  	}
  	...
  	function widget($args, $instance) {
	    ...
	    echo '<div class="juanjimeneztj_social_widget clearfix">';
