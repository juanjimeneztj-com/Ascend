...
/**
 * juanjimeneztj_Image_Grid_Widget widget class
 * 
 */
class juanjimeneztj_post_grid_widget extends WP_Widget {
  ...
  private static $instance = 0;
    public function __construct() {
      $widget_ops = array('classname' => 'juanjimeneztj_image_grid', 'description' => __('This shows a grid of featured images from recent posts or portfolio items', 'juanjimeneztj'));
      parent::__construct('juanjimeneztj_image_grid', __('juanjimeneztj: Post Grid', 'juanjimeneztj'), $widget_ops);
  }
