...
if ( ! class_exists( 'juanjimeneztj_image_widget' ) ) {
	class juanjimeneztj_image_widget extends WP_Widget{
	    ...
	    public function __construct() {
	        $widget_ops = array('classname' => 'juanjimeneztj_about_with_image', 'description' => __('This allows for an image and a simple about text.', 'juanjimeneztj'));
	        parent::__construct('juanjimeneztj_about_with_image', __('juanjimeneztj: Image', 'juanjimeneztj'), $widget_ops);
	    }
            ...
            echo '<div class="kad_img_upload_widget kt-image-widget-'.esc_attr($args['widget_id']).'">';
                ...
                if($uselink == true) {
               	...
               	if(!empty($instance['text'])) {
               		echo '<div class="juanjimeneztj_image_widget_caption">'.$instance['text'].'</div>';
               	}
            echo '</div>';
        echo $after_widget; 
    }
