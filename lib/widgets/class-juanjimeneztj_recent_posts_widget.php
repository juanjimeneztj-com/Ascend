...
/**
 * juanjimeneztj Recent_Posts widget class
...
class juanjimeneztj_recent_posts_widget extends WP_Widget {
	...
	public function __construct() {
  		$widget_ops = array('classname' => 'juanjimeneztj_recent_posts', 'description' => __('This shows the most recent posts on your site with a thumbnail', 'juanjimeneztj'));
  		parent::__construct('juanjimeneztj_recent_posts', __('juanjimeneztj: Recent Posts', 'juanjimeneztj'), $widget_ops);
	}
  	...
  	public function widget($args, $instance) {
    	...
    	if ($r->have_posts()) :
	    	$image_size = apply_filters('juanjimeneztj_post_widget_image_size', array('width'=> 60, 'height' => 60));
	    	$feature_image_size = apply_filters('juanjimeneztj_post_feature_widget_image_size', array('width'=> 420, 'height' => 280));
