...
// Don't duplicate me!
if (!class_exists('ReduxFramework_juanjimeneztj_icons')) {
     ...
     * @since       1.0.0
     */
    class ReduxFramework_juanjimeneztj_icons {
        ...
        public function render() {
             $defaults = array(
                ...
                'content_title' => __ ( 'Icon', 'juanjimeneztj' )
            );
           ...
           echo '<div class="redux-slides-accordion" data-new-content-title="' . esc_attr ( sprintf ( __ ( 'New %s', 'juanjimeneztj' ), $this->field[ 'content_title' ] ) ) . '">';
            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '<span class="button media_upload_button" id="add_' . $x . '">' . __('Upload Icon', 'juanjimeneztj') . '</span>';
                    ...
                    echo '</div>' . "\n";
                   $icon_option = juanjimeneztj_icon_list();
                        $placeholder = (isset($this->field['placeholder']['icon_o'])) ? esc_attr($this->field['placeholder']['icon_o']) : __( 'Select an Icon', 'juanjimeneztj' );
                    ...
                    echo '<li><input type="hidden" id="' . esc_attr($this->field['id']) . '-url_' . $x . '" name="' . esc_attr($this->field['name']) . '[' . $x . '][url]" value="' . esc_attr($slide['url']) . '" class="full-text upload" placeholder="'.__('URL', 'juanjimeneztj').'" /></li>';
                    ...
                    echo '<li><textarea name="' . esc_attr($this->field['name']) . '[' . $x . '][description]" id="' . esc_attr($this->field['id']) . '-description_' . $x . '" placeholder="'.__('Description', 'juanjimeneztj').'" class="large-text" rows="6">' . esc_attr($slide['description']) . '</textarea></li>';
                    echo '<li><input type="text" id="' . esc_attr($this->field['id']) . '-link_' . $x . '" name="' . esc_attr($this->field['name']) . '[' . $x . '][link]" value="' . esc_attr($slide['link']) . '" placeholder="'.__('Icon Link', 'juanjimeneztj').'" class="full-text" /></li>';
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion redux-slides-remove">' . __('Delete Icon', 'juanjimeneztj') . '</a></li>';
            ...
            if ($x == 0) {
                ...
                $icon_option = juanjimeneztj_icon_list(); 
                        ...
                        echo '</select>';                           
                echo '<ul id="' . esc_attr($this->field['id']) . '-ul" class="redux-slides-list">';
                $placeholder = (isset($this->field['placeholder']['url'])) ? esc_attr($this->field['placeholder']['url']) : __( 'URL', 'juanjimeneztj' );
                ...
                $placeholder = (isset($this->field['placeholder']['title'])) ? esc_attr($this->field['placeholder']['title']) : __( 'Title', 'juanjimeneztj' );
                ...
                $placeholder = (isset($this->field['placeholder']['description'])) ? esc_attr($this->field['placeholder']['description']) : __( 'Description', 'juanjimeneztj' );
                ...
                $placeholder = (isset($this->field['placeholder']['link'])) ? esc_attr($this->field['placeholder']['link']) : __( 'Icon Link', 'juanjimeneztj' );
            ...
            echo '</div><a href="javascript:void(0);" class="button redux-slides-add2 kad_redux-icon-add button-primary" rel-id="' . esc_attr($this->field['id']) . '-ul" rel-name="' . esc_attr($this->field['name']) . '[title][]">' . __('Add Icon', 'juanjimeneztj') . '</a><br/>';
           ...
           public function enqueue () {
            ...
            wp_enqueue_script (
                'juanjimeneztj-field-icons-js',  
                get_template_directory_uri() . '/themeoptions/options/extensions/juanjimeneztj_icons/juanjimeneztj_icons/field_juanjimeneztj_icons.js', 
            ...
            wp_enqueue_style (
                'juanjimeneztj-field-icons-css', 
                get_template_directory_uri() . '/themeoptions/options/extensions/juanjimeneztj_icons/juanjimeneztj_icons/field_juanjimeneztj_icons.css', 
                time (), 
                true
            );
        }              
